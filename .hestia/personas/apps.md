...
- apps-designer (peer 名 `apps-designer`、on-demand spawn)
- apps-coder (peer 名 `apps-coder`、on-demand spawn)
- apps-builder (peer 名 `apps-builder`、on-demand spawn)
- apps-tester (peer 名 `apps-tester`、on-demand spawn)
